<template>
	<div>
		<form @submit.prevent="addStudent(this.form)">
			<div class="row">
				<div class="form-group col-md-12">
					<img v-if="imagePreview" :src="imagePreview" style="width: 100px; height: 100px;"><br>
					<label for="image" class="mt-3">Image</label>
					<button type="button" class="btn btn-primary btn-sm" @click="imagePreview = null,form.image = null" :disabled="!imagePreview">Delete Preview Image</button>
				...
				<div class="form-group col-md-8">
					...
					<input type="text" placeholder="Email" id="email" class="form-control" v-model="form.email">
			...
			<button class="btn btn-success btn-sm mt-3">Add Student</button>
		</form>
	</div>
</template>
